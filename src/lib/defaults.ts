...
export const DEFAULT_BUTTONS: TransformButton[] = [
  ...
  { id: "space-to-newline", name: "s↵", transform: "space-to-newline", description: "空格替换为换行", visible: false },
  ...
  { id: "json-format", name: "JSON", transform: "json-format", description: "JSON 格式化", visible: false },
